 ...
 //               Helpers.RoleHelpers.AddUserToRole(user.Id, "Submitter");
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                Helpers.EmailHelpers.SendEmail(new Helpers.EmailInformation()
                {
                    Title = "Squash - Account Recovery",
                    Body = "<a href="+callbackUrl+">Click To Recover Password!</a>",
        ...
        public ActionResult UserSettings(UserSettingsViewModel ViewModel)
        {
            ...
            if (userExists && user.Email != EditedUser.Email)
            {
            ...
            user.UserName = EditedUser.Email;
